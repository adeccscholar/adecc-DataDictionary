...
namespace own {
   ...
   static_assert(!is_vector_pair<std::vector<int>>::value, "std::vector<int> ist kein std::vector with pair as value");
   static_assert(is_vector_pair<std::vector<std::pair<int, int>>>::value, "std::vector<std::pair<int, int>> ist ein std::vector with pair as value");
